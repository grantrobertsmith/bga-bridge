 ...
 * states.inc.php
 *
 * Bridge game states description
 *
 */
...
$machinestates = array(
    ...
    20 => array(
        ...
        "transitions" => array( "playerBid" => 21 )
    ),  
    ...
    21 => array(
        ...
        "transitions" => array( "nextPlayerBid" => 22 )
    ),
    22 => array(
        "name" => "nextPlayerBid",
        "description" => "",
        ...
        "transitions" => array( "playerBid" => 21, "newTrick" => 30, "newHand" => 20 )
    ),
    ...
    31 => array(
        ...
        "transitions" => array( "nextPlayer" => 32 , "zombiePlayCard" => 80 )
    ),
    32 => array(
        "name" => "nextPlayer",
        ...
        "type" => "game",
        "action" => "stNextPlayer",
        "transitions" => array( "playerTurn" => 31, "newTrick" => 30, "endHand" => 40 )
    ),
    ...
    40 => array(
        "name" => "endHand",
        "description" => clienttranslate("Updating the score..."),
        "type" => "game",
        "action" => "stEndHand",
